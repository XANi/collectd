...
static int mysql_read_wsrep_stats (mysql_database_t *db, MYSQL *con)
{
	...
	struct {
		...
		{ "apply_oooe",                "operations",   DS_TYPE_DERIVE },
		{ "apply_oool",                "operations",   DS_TYPE_DERIVE },
		{ "causal_reads",              "operations",   DS_TYPE_DERIVE },
		{ "commit_oooe",               "operations",   DS_TYPE_DERIVE },
		{ "commit_oool",               "operations",   DS_TYPE_DERIVE },
		{ "flow_control_recv",         "operations",   DS_TYPE_DERIVE },
		{ "flow_control_sent",         "operations",   DS_TYPE_DERIVE },
		{ "local_bf_aborts",           "operations",   DS_TYPE_DERIVE },
		{ "local_cert_failures",       "operations",   DS_TYPE_DERIVE },
		{ "local_commits",             "operations",   DS_TYPE_DERIVE },
		{ "local_replays",             "operations",   DS_TYPE_DERIVE },
		{ "received",                  "operations",   DS_TYPE_DERIVE },
		{ "replicated",                "operations",   DS_TYPE_DERIVE },
		{ "received_bytes",            "total_bytes",  DS_TYPE_DERIVE },
		{ "replicated_bytes",          "total_bytes",  DS_TYPE_DERIVE },

		{ "apply_window",              "window_size",   DS_TYPE_GAUGE },
		{ "cluster_size",              "gauge",         DS_TYPE_GAUGE },
		{ "cert_deps_distance",        "gauge",         DS_TYPE_GAUGE },
		{ "commit_window",             "window_size",   DS_TYPE_GAUGE },
		{ "local_recv_queue",          "queue_length",  DS_TYPE_GAUGE },
		{ "local_recv_queue_avg",      "queue_length",  DS_TYPE_GAUGE },
		{ "local_send_queue",          "queue_length",  DS_TYPE_GAUGE },
		{ "local_send_queue_avg",      "queue_length",  DS_TYPE_GAUGE },
